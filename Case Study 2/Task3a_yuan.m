...
for i=2:N
    ...
    % Generator flow of north island in m^3/s
    if t<8760/4 && t>0.75*8760/4 % Reducing generator flow in fall and winter to store water
        F_gen_NI = 0.9*F_in_NI;
    else
        F_gen_NI = 1.05*F_in_NI; % Increasing generator flow in spring and summer
    end
